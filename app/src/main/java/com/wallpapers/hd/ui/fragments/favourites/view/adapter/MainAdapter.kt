package com.wallpapers.hd.ui.fragments.favourites.view.adapter
    ...
    inner class MainViewHolder(private val binding: WallpapersItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(sizesModel: SizesModel) {
            ...
            binding.ivWallpapers.setOnClickListener {
                ...
                MainApplication.sizedModel = sizesModel
                it.findNavController().navigate(R.id.action_favouritesFragment_to_fullScreenFragment)
            }
        }
    }
